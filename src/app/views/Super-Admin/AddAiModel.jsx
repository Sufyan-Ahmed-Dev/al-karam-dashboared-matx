      ...
      <div className="row p-4 ">
        ...
        <div class="card-body">
          ...
          <div class="input-group mb-3 col-10">
            ...
            <input type="text" class="form-control me-3" placeholder="Enter Model Name" aria-label=" Model Name" />

            <input type="text" class="form-control ms-3" placeholder="Associated Company" aria-label="Associated Company" />
          </div>
