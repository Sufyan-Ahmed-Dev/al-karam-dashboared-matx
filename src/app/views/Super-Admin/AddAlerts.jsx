      ...
      <div className="row p-4 ">
        <div className="card" >
          ...
          <div className="card-body">
            <div className='p-0'>
              <p className='bg-danger ps-3 p-2 text-white'> Add New Alert</p>
            </div>
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" style={{ "minWidth": "150px" }}>Modal Associated</th>
