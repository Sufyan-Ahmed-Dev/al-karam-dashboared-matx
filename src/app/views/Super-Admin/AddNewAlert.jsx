...
<div className="container bg-white table-wrapper" >
  <div className="row p-4 ">
    ...
    <div class="card-body">
      <div className='p-0'>
        <p className='bg-danger ps-3 p-2 text-white'>New Alert</p>
      </div>

      <div class="input-group mb-3 col-10">

        <input type="text" class="form-control me-3" placeholder="Enter Alert Name" aria-label=" Alert Name" />

        <input type="text" class="form-control ms-3" placeholder="Select AI Model" aria-label="Select AI Model" />
      </div>
      <button className='btn btn-success' > Click to Add Ai Model</button>
    </div>
  </div>
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-8 "><h2>Alert List</h2></div>
              <div class="col-sm-4">
                <input type="text" class="form-control me-3 mb-2" placeholder="Search List " aria-label=" Alert Name" />
              </div>
            </div>
